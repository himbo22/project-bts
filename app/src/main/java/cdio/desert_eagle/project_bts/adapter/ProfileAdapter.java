...
public class ProfileAdapter extends RecyclerView.Adapter<ProfileAdapter.MyViewHolder> {
    ...
    public ProfileAdapter(Context context, OnProfileItemListener listener) {
...
//        });
        ...
        listener.liked(userPost.getAuthor(), userPost.getId(), position);

        if (userPost.isLikedByUser()) {
            holder.binding.imgReact.setImageResource(R.drawable.liked);
        } else {
            holder.binding.imgReact.setImageResource(R.drawable.like);
        }
...
//            listener.option();
        ...
        holder.binding.imgReact.setOnClickListener(v -> {
            listener.like(userPost.getAuthor(), userPost.getId(), position);
...
//            });
    ...
    public void updateItem(int pos, Boolean likedByUser) {
        this.userPosts.get(pos).setLikedByUser(likedByUser);
        notifyDataSetChanged();
    }
